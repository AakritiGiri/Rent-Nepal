...
function Navbar() {
  ...
  return (
    <AppBar position='sticky' sx={{ backgroundColor: '#397168' }} >
                ...
                <>
                  <Box sx={{ flexGrow: 0 }}>
                    ...
                    >
                      ...
                      >
                        <MenuItem onClick={handleCloseUserMenu}>
                          <Typography textAlign='center' variant='body2'  >Dashboard</Typography>
                        </MenuItem>
                      </Link>
                      ...
                      >
                        <Typography textAlign='center' variant='body2' >Log out</Typography>
                      </MenuItem>
                    </Menu>
                  </Box>
                </>
